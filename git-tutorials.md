...
git에 파일을 업로드할 때에는 파일 내용 뿐만 아니라 변경 내용들도 같이 올라갑니다.

이를 히스토리 라고 하는데요

변경 기록들 정도로 생각하시면 됩니다.

문제는 내 로컬의 히스토리와 깃의 히스토리가 일치하지 않는 경우가 있다는 것입니다.
...
하지만 내 로컬 저장소에서 내가 `example.py`가 아래와 같은 내용으로 있다고 해봅시다.
